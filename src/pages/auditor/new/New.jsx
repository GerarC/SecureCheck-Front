		...
		companyService.create(newCompany).then(response => {
			if(response.ok) redirect("/auditor/empresas")
                    ...
                    exception => {
                        ...
                        if(exception.errors) exception.errors.forEach(
				...
				<div className="bottom">
					...
					<div className="right">
						<form onSubmit={handleSubmit}>
							...
							<TextField id="email" className="formInput" label="Correo de contacto" />
							<TextField id="phone" className="formInput" label="Teléfono de contacto" />
